...
function occupiedEnd(startMinute,duration){return startMinute+durationMinutes(duration)+(CFG.travelBufferMinutes||30)}
 ...
 window.AndeyData={slots,mins,durationMinutes,rangesOverlap,friendlyError,listBusy,createBooking,startPayment,markDemoPaid,adminSignIn,listAdminBookings,updateStatus,findBooking,customerCancel,customerReschedule,listBlocks,addBlock,deleteBlock,minutesToTime,priceFor,isSwim,serviceDurationOptions,occupiedEnd,resetDemo};
})();